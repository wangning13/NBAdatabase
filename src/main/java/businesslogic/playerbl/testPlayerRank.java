...
//		System.out.println(playerinfoVO.getWeight());
		...
		ArrayList<PlayerVO> playerVOs = playerRank.getAllPlayerdata("backboard", "DESC");
		for (int i = 0; i < 10; i++) {
//			System.out.println(playerVOs.get(i).getAppearance());
//			System.out.println(playerVOs.get(i).getFieldGoal());
//			System.out.println(playerVOs.get(i).getFieldGoalAttempts());
//			System.out.println(playerVOs.get(i).getFielfGoalShotPercentage());
		}
